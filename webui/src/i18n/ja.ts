...
export const ja: Record<TranslationKey, string> = {
  ...
  "serverDetail.tab.schedules": "スケジュール",
  ...
  "serverDetail.error.configInvalidShape":
    "設定の上書きはJSONオブジェクトである必要があります。入れ子は上書きのオブジェクト自体を含めて8階層までなので、それより深い値は階層を浅くしてください。",
  "serverDetail.error.configLoneSurrogate":
    "上書きのキーまたは値に壊れた文字が含まれています。絵文字が貼り付けの途中で切れた場合によく起こります。該当の文字を入力し直すか削除してください。",
  ...
  // Schedules tab (WEBUI_SPEC.md 6.13, issue #1842).
  "schedules.noRead": "スケジュールを表示する権限がありません。",
  "schedules.loading": "スケジュールを読み込んでいます…",
  "schedules.loadError": "スケジュールを読み込めませんでした。",
  "schedules.empty": "スケジュールはまだありません。",
  "schedules.none": "—",
  "schedules.create": "+ スケジュールを作成",
  "schedules.edit": "編集",
  "schedules.delete": "削除",
  "schedules.history": "実行履歴",
  "schedules.enabledLabel": "スケジュール「{name}」を有効化",
  "schedules.col.name": "名前",
  "schedules.col.action": "アクション",
  "schedules.col.cadence": "周期",
  "schedules.col.timezone": "タイムゾーン",
  "schedules.col.enabled": "有効",
  "schedules.col.lastRun": "前回の実行",
  "schedules.col.nextRun": "次回の実行",
  "schedules.action.command": "コマンド送信",
  "schedules.action.start": "起動",
  "schedules.action.stop": "停止",
  "schedules.action.restart": "再起動",
  "schedules.action.backup": "バックアップ",
  "schedules.cadence.cron": "Cron: {cron}",
  "schedules.cadence.dailyAt": "毎日 {time}",
  "schedules.cadence.daysAt": "{days} {time}",
  "schedules.cadence.everySeconds": "{count}秒ごと",
  "schedules.cadence.everyMinutes": "{count}分ごと",
  "schedules.cadence.everyHours": "{count}時間ごと",
  "schedules.created": "スケジュールを作成しました。",
  "schedules.updated": "スケジュールを更新しました。",
  "schedules.deleted": "スケジュールを削除しました。",
  "schedules.toggle.enabled": "スケジュールを有効にしました。",
  "schedules.toggle.disabled": "スケジュールを無効にしました。",
  "schedules.dialog.createTitle": "スケジュールを作成",
  "schedules.dialog.editTitle": "スケジュールを編集",
  "schedules.dialog.nameLabel": "名前",
  "schedules.dialog.actionLabel": "アクション",
  "schedules.dialog.actionLocked":
    "アクションは変更できません。変更するには削除して作り直してください。",
  "schedules.dialog.cadenceLabel": "周期",
  "schedules.dialog.cadence.interval": "X分/時間ごとに実行",
  "schedules.dialog.cadence.daily": "毎日決まった時刻に実行",
  "schedules.dialog.cadence.weekly": "特定の曜日に実行",
  "schedules.dialog.cadence.cron": "Cron式（上級者向け）",
  "schedules.dialog.cronHelp": "標準の5フィールドCron式（分 時 日 月 曜日）",
  "schedules.dialog.day.mon": "月",
  "schedules.dialog.day.tue": "火",
  "schedules.dialog.day.wed": "水",
  "schedules.dialog.day.thu": "木",
  "schedules.dialog.day.fri": "金",
  "schedules.dialog.day.sat": "土",
  ...
  "schedules.dialog.unit.hours": "時間",
  "schedules.dialog.cronLabel": "Cron式",
  "schedules.dialog.cronPlaceholder": "例: 0 4 * * *",
  "schedules.dialog.timezoneLabel": "タイムゾーン",
  "schedules.dialog.commandLabel": "コマンド",
  ...
  "schedules.dialog.warning.offset": "何分前",
  "schedules.dialog.warning.message": "メッセージ",
  "schedules.dialog.warning.add": "+ 警告を追加",
  "schedules.dialog.warning.remove": "削除",
  "schedules.dialog.save": "変更を保存",
  "schedules.dialog.create": "スケジュールを作成",
  ...
  "schedules.deleteDialog.body":
    "「{name}」を削除しますか？実行履歴も一緒に削除されます。",
  "schedules.deleteDialog.confirm": "スケジュールを削除",
  "schedules.runs.title": "実行履歴 — {name}",
  "schedules.runs.loading": "実行履歴を読み込んでいます…",
  "schedules.runs.loadError": "実行履歴を読み込めませんでした。",
  "schedules.runs.empty": "まだ実行記録はありません。",
  "schedules.runs.col.outcome": "結果",
  "schedules.runs.col.detail": "詳細",
  "schedules.runs.col.started": "開始",
  "schedules.runs.col.finished": "終了",
  "schedules.runs.outcome.success": "成功",
  "schedules.runs.outcome.failure": "失敗",
  "schedules.runs.outcome.skipped": "スキップ",
  ...
  // Schedule family (issue #1842): the general scheduler CRUD surface.
  "communitySettings.roles.family.schedule": "スケジュール",
  ...
  "communitySettings.roles.code.schedule:read": "閲覧",
  "communitySettings.roles.code.schedule:manage": "管理",
