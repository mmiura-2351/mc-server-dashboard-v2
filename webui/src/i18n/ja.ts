...
export const ja: Record<TranslationKey, string> = {
  ...
  // Mod library (issue #1266).
  "nav.mods": "Mod",
  "page.mods": "Mod",
  "mods.subtitle": "Minecraftサーバーで使用するModのアップロードと管理。",
  "mods.loading": "Modを読み込んでいます…",
  "mods.loadError": "Modを読み込めませんでした。",
  "mods.empty": "まだModがありません。",
  "mods.upload": "Modをアップロード",
  "mods.browse": "Modrinthを検索",
  "mods.col.displayName": "名前",
  "mods.col.version": "バージョン",
  "mods.col.loader": "ローダー",
  "mods.col.mcVersions": "MCバージョン",
  "mods.col.side": "対象",
  "mods.col.uploaded": "アップロード日時",
  "mods.col.uploader": "アップロード者",
  "mods.side.server": "サーバー",
  "mods.side.client": "クライアント",
  "mods.side.both": "両方",
  "mods.download": "ダウンロード",
  "mods.delete": "削除",
  "mods.uploadDialog.title": "Modをアップロード",
  "mods.uploadDialog.displayName": "表示名",
  "mods.uploadDialog.file": "ファイル（.jar）",
  "mods.uploadDialog.side": "対象（任意）",
  "mods.uploadDialog.sideAuto": "自動検出",
  "mods.uploadDialog.submit": "アップロード",
  "mods.uploadDialog.uploading": "アップロードしています…",
  "mods.uploaded": "Modをアップロードしました。",
  "mods.deleted": "Modを削除しました。",
  "mods.deleteDialog.title": "Modを削除",
  "mods.deleteDialog.body":
    "Modを完全に削除します。サーバーに割り当て済みのModは削除できません。",
  "mods.deleteDialog.confirm": "Modを削除",
  "mods.deleteDialog.prompt": "削除を有効にするには表示名を入力",
  "mods.error.tooLarge":
    "ファイルサイズが256 MiBのアップロード上限を超えています。",
  "mods.error.uploadFailed": "Modをアップロードできませんでした。",
  "mods.error.deleteFailed": "Modを削除できませんでした。",
  "mods.error.inUse":
    "このModは1つ以上のサーバーに割り当てられているため、削除できません。",
  "mods.error.downloadFailed": "Modをダウンロードできませんでした。",
  "mods.browseDialog.title": "Modrinthを検索",
  "mods.browseDialog.query": "検索",
  "mods.browseDialog.queryPlaceholder": "Modを検索…",
  "mods.browseDialog.loader": "ローダー",
  "mods.browseDialog.gameVersion": "ゲームバージョン",
  "mods.browseDialog.any": "指定なし",
  ...
  "mods.browseDialog.searchFailed": "Modrinthを検索できませんでした。",
  "mods.browseDialog.importFailed": "Modをインポートできませんでした。",
  "mods.browseDialog.back": "検索結果に戻る",
  "mods.browseDialog.versions": "バージョン",
  "mods.browseDialog.loadingProject": "バージョンを読み込んでいます…",
  "mods.browseDialog.projectFailed": "プロジェクトを読み込めませんでした。",
  "mods.browseDialog.noVersions": "一致するバージョンがありません。",
