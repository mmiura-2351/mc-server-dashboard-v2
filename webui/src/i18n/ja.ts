...
export const ja: Record<TranslationKey, string> = {
  ...
  "schedules.dialog.cadence.interval": "間隔",
  "schedules.dialog.cadence.dailyWeekly": "日次 / 週次",
  "schedules.dialog.cadence.cron": "Cron（上級者向け）",
  "schedules.dialog.repeatLabel": "繰り返し",
  "schedules.dialog.repeat.everyDay": "毎日",
  "schedules.dialog.repeat.specificDays": "曜日を指定",
