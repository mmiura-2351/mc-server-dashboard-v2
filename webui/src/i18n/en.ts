...
export const en = {
  ...
  // Mod library (issue #1266). Mirrors the resource pack library page, with a
  // side badge (server/client/both) and a Modrinth search/import modal.
  "nav.mods": "Mods",
  "page.mods": "Mods",
  "mods.subtitle": "Upload and manage mods for use with Minecraft servers.",
  "mods.loading": "Loading mods…",
  "mods.loadError": "Could not load mods.",
  "mods.empty": "No mods yet.",
  "mods.upload": "Upload mod",
  "mods.browse": "Browse Modrinth",
  "mods.col.displayName": "Name",
  "mods.col.version": "Version",
  "mods.col.loader": "Loader",
  "mods.col.mcVersions": "MC versions",
  "mods.col.side": "Side",
  "mods.col.uploaded": "Uploaded",
  "mods.col.uploader": "Uploader",
  "mods.side.server": "Server",
  "mods.side.client": "Client",
  "mods.side.both": "Both",
  "mods.download": "Download",
  "mods.delete": "Delete",
  "mods.uploadDialog.title": "Upload mod",
  "mods.uploadDialog.displayName": "Display name",
  "mods.uploadDialog.file": "File (.jar)",
  "mods.uploadDialog.side": "Side (optional)",
  "mods.uploadDialog.sideAuto": "Auto-detect",
  "mods.uploadDialog.submit": "Upload",
  "mods.uploadDialog.uploading": "Uploading…",
  "mods.uploaded": "Mod uploaded.",
  "mods.deleted": "Mod deleted.",
  "mods.deleteDialog.title": "Delete mod",
  "mods.deleteDialog.body":
    "This permanently deletes the mod. Mods currently assigned to servers cannot be deleted.",
  "mods.deleteDialog.confirm": "Delete mod",
  "mods.deleteDialog.prompt": "Type the display name to enable deletion",
  "mods.error.tooLarge": "That file exceeds the 256 MiB upload limit.",
  "mods.error.uploadFailed": "Could not upload the mod.",
  "mods.error.deleteFailed": "Could not delete the mod.",
  "mods.error.inUse":
    "This mod is assigned to one or more servers and cannot be deleted.",
  "mods.error.downloadFailed": "Could not download the mod.",
  "mods.browseDialog.title": "Browse Modrinth",
  "mods.browseDialog.query": "Search",
  "mods.browseDialog.queryPlaceholder": "Search mods…",
  "mods.browseDialog.loader": "Loader",
  "mods.browseDialog.gameVersion": "Game version",
  "mods.browseDialog.any": "Any",
  ...
  "mods.browseDialog.searchFailed": "Could not search Modrinth.",
  "mods.browseDialog.importFailed": "Could not import the mod.",
  "mods.browseDialog.back": "Back to results",
  "mods.browseDialog.versions": "Versions",
  "mods.browseDialog.loadingProject": "Loading versions…",
  "mods.browseDialog.projectFailed": "Could not load the project.",
  "mods.browseDialog.noVersions": "No matching versions.",
