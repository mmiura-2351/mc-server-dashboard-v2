...
export const en = {
  ...
  "serverDetail.tab.schedules": "Schedules",
  ...
  // Schedules tab (WEBUI_SPEC.md 6.13, issue #1842). One contiguous block to
  // keep merge conflicts with sibling tab PRs minimal.
  "schedules.noRead": "You do not have permission to view schedules.",
  ...
  "schedules.enabledLabel": "Enable schedule {name}",
  "schedules.col.name": "Name",
  "schedules.col.action": "Action",
  "schedules.col.cadence": "Cadence",
  "schedules.col.timezone": "Time zone",
  "schedules.col.enabled": "Enabled",
  "schedules.col.lastRun": "Last run",
  "schedules.col.nextRun": "Next run",
  "schedules.action.command": "Send command",
  "schedules.action.start": "Start",
  "schedules.action.stop": "Stop",
  "schedules.action.restart": "Restart",
  "schedules.action.backup": "Back up",
  "schedules.cadence.cron": "Cron: {cron}",
  "schedules.cadence.dailyAt": "Daily at {time}",
  "schedules.cadence.daysAt": "{days} at {time}",
  "schedules.cadence.everySeconds": "Every {count}s",
  "schedules.cadence.everyMinutes": "Every {count} min",
  "schedules.cadence.everyHours": "Every {count} h",
  "schedules.created": "Schedule created.",
  "schedules.updated": "Schedule updated.",
  "schedules.deleted": "Schedule deleted.",
  "schedules.toggle.enabled": "Schedule enabled.",
  "schedules.toggle.disabled": "Schedule disabled.",
  "schedules.dialog.createTitle": "Create schedule",
  "schedules.dialog.editTitle": "Edit schedule",
  "schedules.dialog.nameLabel": "Name",
  "schedules.dialog.actionLabel": "Action",
  ...
  "schedules.dialog.day.thu": "Thu",
  "schedules.dialog.day.fri": "Fri",
  "schedules.dialog.day.sat": "Sat",
  ...
  "schedules.dialog.unit.hours": "hours",
  "schedules.dialog.cronLabel": "Cron expression",
  "schedules.dialog.cronPlaceholder": "e.g. 0 4 * * *",
  "schedules.dialog.timezoneLabel": "Time zone",
  ...
  "schedules.dialog.warning.offset": "Minutes before",
  "schedules.dialog.warning.message": "Message",
  "schedules.dialog.warning.add": "+ Add warning",
  "schedules.dialog.warning.remove": "Remove",
  "schedules.dialog.save": "Save changes",
  "schedules.dialog.create": "Create schedule",
  ...
  "schedules.deleteDialog.body":
    "Delete “{name}”? Its run history is removed with it.",
  "schedules.deleteDialog.confirm": "Delete schedule",
  "schedules.runs.title": "Run history — {name}",
  "schedules.runs.loading": "Loading run history…",
  "schedules.runs.loadError": "Could not load run history.",
  "schedules.runs.empty": "No runs recorded yet.",
  "schedules.runs.col.outcome": "Outcome",
  "schedules.runs.col.detail": "Detail",
  "schedules.runs.col.started": "Started",
  "schedules.runs.col.finished": "Finished",
  "schedules.runs.outcome.success": "Success",
  "schedules.runs.outcome.failure": "Failure",
  "schedules.runs.outcome.skipped": "Skipped",
  ...
  "communitySettings.roles.family.schedule": "Schedules",
  ...
  "communitySettings.roles.code.schedule:read": "Read",
  "communitySettings.roles.code.schedule:manage": "Manage",
