...
func TestLoadDefaults(t *testing.T) {
	...
	if cfg.Bedrock.TunnelMaxConnsPerIP != 64 {
		t.Errorf("bedrock.tunnel_max_conns_per_ip default = %d", cfg.Bedrock.TunnelMaxConnsPerIP)
	}
...
func TestLoadEnvOverride(t *testing.T) {
	...
	if cfg.Bedrock.TunnelMaxConnsPerIP != 48 {
		t.Errorf("env override bedrock.tunnel_max_conns_per_ip = %d", cfg.Bedrock.TunnelMaxConnsPerIP)
	}
