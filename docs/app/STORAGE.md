...
mode signal adds no new trust surface. Backup create/restore and the integrity
sweep CLI operate on at-rest store/archive artifacts and stay strict. Transport
security
