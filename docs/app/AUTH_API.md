...
| family- / logout- / superseded-revoked token | `401`, whole family revoked + DENIED audit event | same |
...
or as a *superseded* both-transports cookie token (issue #384) is never graced —
