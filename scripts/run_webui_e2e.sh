...
# postgres:18.4 (Debian), the api.yml-vetted digest (docs/dev/DEPENDENCIES.md).
PG_IMAGE="postgres@sha256:a02db8cac496f15b094798a38254f14d6e00741f709360e5e00bb6668ea31636"
