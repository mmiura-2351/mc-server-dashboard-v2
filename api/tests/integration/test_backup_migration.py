"""Data-bearing migration scenarios for ``backup`` against real PostgreSQL.

Runs only when ``MCD_TEST_DATABASE_URL`` is set (the CI Postgres service);
skipped otherwise (TESTING.md Section 5). Exercises health backfill, allowed
values, and downgrade remapping (DATABASE.md Section 8).
"""
