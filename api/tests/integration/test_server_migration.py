"""Server migration allowed-value scenarios against real PostgreSQL.

Runs only when ``MCD_TEST_DATABASE_URL`` is set (the CI Postgres service);
skipped otherwise (TESTING.md Section 5). Proves the migrated server-type CHECK
admits ``fabric`` (DATABASE.md Section 7).
"""
